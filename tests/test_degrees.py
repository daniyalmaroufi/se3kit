...
from se3kit.utils import deg2rad  # Ensure your utils module is accessible
...
class TestDegrees(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertAlmostEqual(d.rad, deg2rad(45))
    ...
    def test_multiple_conversions(self):
        ...
        for deg in [0, 45, 90, 180, 360]:
            d.deg = deg
            self.assertAlmostEqual(d.rad, deg2rad(deg))
            # Now set via radians and check degrees
            d.rad = deg2rad(deg)
            self.assertAlmostEqual(d.deg, deg)
    ...
    def test_negative_angles(self):
        ...
        self.assertAlmostEqual(d.rad, deg2rad(-90))
        d.rad = deg2rad(-45)
        self.assertAlmostEqual(d.deg, -45)
